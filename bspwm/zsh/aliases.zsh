...
alias diskbagla="sudo mount /dev/nvme1n1p5 /mnt"
alias hepsinimzala="git rebase -i --root --exec 'git commit --amend --no-edit -n -S' -X theirs"
# vim:ft=zsh
# alias phonecamera="sudo modprobe v4l2loopback video_nr='3' card_label='phone'"
