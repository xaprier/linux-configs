...
##
# Medpointr
export LD_LIBRARY_PATH="/usr/local/lib:$HOME/Qt/5.15.2/gcc_64/lib"
...
export QT_SELECTION="$HOME/Qt/5.15.2/gcc_64/bin/qmake"
export CMAKE_PREFIX_PATH="$HOME/Qt/5.15.2/gcc_64/lib/cmake:$CMAKE_PREFIX_PATH"
